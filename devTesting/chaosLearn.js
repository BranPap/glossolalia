...
let currentLanguage = getQueryParam("lang") || "Finnish"; 
let currentTopic = getQueryParam("topic") || "animals";

const allLanguages = Object.keys(nounVocab[currentTopic][0])
.filter(k => k !== "image" && k !== "English" && !k.endsWith("Morph"));
...
const gameState = {
  ...
  var welcomeSlide = {
    ...
    stimulus: `<h1>Welcome to Glossolalia!</h1><br>
               <p>You are currently practicing animal names in <strong>?!*&_!@?$#?</strong>.</p>`,
    choices: ["Begin"]
  };
